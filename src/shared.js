...
export const emailforChair = ['kraftp2@numberWithCommas.gov','Roger.Milne@cancervic.org.au','ahearntu@nih.gov', 'garciacm@nih.gov', 'sbehpour@deloitte.com','kopchickbp@nih.gov'];
//  [
