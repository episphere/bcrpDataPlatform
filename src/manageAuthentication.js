...
export const loginObs = () => {
  location.href = `https://account.box.com/api/oauth2/authorize?response_type=code&client_id=${config.iniAppStage.client_id}&redirect_uri=${location.href}&state=${config.iniAppStage.stateIni}`;
};
