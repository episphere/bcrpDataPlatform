    ...
    if (descriptions.length > 0) {
        template = `
            <div class="row m-0 pt-2 pb-2 align-left div-sticky" style="border-bottom: 1px solid rgb(0,0,0, 0.1);">
                <div class="col-md-3 font-bold ws-nowrap pl-2">
                    Cohort <button class="transparent-btn sort-column" data-column-name="Cohort name"><i class="fas fa-sort"></i></button>
                </div>
                <div class="col-md-2 font-bold ws-nowrap">
                    Acronym <button class="transparent-btn sort-column" data-column-name="Acronym"><i class="fas fa-sort"></i></button>
                </div>
                <div class="col-md-2 font-bold ws-nowrap">
                    Region <button class="transparent-btn sort-column" data-column-name="Region"><i class="fas fa-sort"></i></button>
                </div>
                <div class="col-md-3 font-bold ws-nowrap">
                    Population Type <button class="transparent-btn sort-column" data-column-name="Population type"><i class="fas fa-sort"></i></button>
                </div>
...
export const pageSizeTemplate = (array, startPageSize) => {
    ...
    let template = `<select class="form-control" id="pageSizeSelector">`;
...
export const paginationTemplate = (array) => {
    ...
    array.forEach((a, i) => {
        if (i === 0) {
            template += `
                <li class="page-item">
                    <button class="page-link" id="previousPage" data-previous="1" aria-label="Previous"><!-- Removed "transparent-btn" class as it isn't present in Confluence -->
        ...
        template += `
            <li class="page-item">
                <button class="page-link ${i === 0 ? 'active-page' : ''}" data-page=${a}>${a}</button><!-- Removed "transparent-btn" class as it isn't present in Confluence -->
            </li>
        `;
        ...
        if (i === (array.length - 1)) {
            template += `
                <li class="page-item">
                    <button class="page-link" id="nextPage" data-next="1" aria-label="Next"><!-- Removed "transparent-btn" class as it isn't present in Confluence -->
